...
const HeroPage = () => {
  return (
    ...
    <Navbar />
    <article className='w-2/5 absolute top-[25%] p-20 '>
    ...
    <div className="bag px-4 py-4 rounded-full bg-zinc-300 text-5xl text-purple-500 absolute bottom-[-10%] left-[-10%] "><i className="fa-solid fa-bag-shopping"></i></div>
    <div className="w-2/3 bg-zinc-400 absolute bottom-[-20%] right-[-30%] p-2 rounded-sm">
        <h1 className='text-sm font-semibold'>Buy for rent <i className="fa-solid fa-bag-shopping  text-purple-500 text-lg"></i></h1>
